...
<aside class="col-lg-3 col-md-3 col-sm-4">
  <nav role="navigation">
    <ul class="sidebar-nav list-group no-margin" id="sidebar-nav">
      ...
      <li class="list-group-item list-toggle <?=activeYearOrNot(2559)?>">
        <a data-toggle="collapse" data-parent="#sidebar-nav" href="#collapse-3">2559</a>
        <!-- <ul id="collapse-1" class="collapse"> -->
        <ul id="collapse-3" class="collapse in">
          <li class="<?=activeProjectOrNot('cmcamp')?>"><a href="challenge_2016_chiangmai_camp.php"><i class="fa fa-angle-right"></i> Astronomical and Voluntary Camp</a></li>
          <li class="<?=activeProjectOrNot('precamp1')?>"><a href="challenge_2016_geo_precamp1.php"><i class="fa fa-angle-right"></i> GEO Pre-Camp #1</a></li>
